 ...
 * @since 2.0.0
 */
class FileHandle extends window.__TAURI__.core.Resource {
    /**
...
export { BaseDirectory, FileHandle, SeekMode, copyFile, create, exists, lstat, mkdir, open, readDir, readFile, readTextFile, readTextFileLines, remove, rename, size, stat, truncate, watch, watchImmediate, writeFile, writeTextFile };
